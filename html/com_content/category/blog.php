...
<div class="rt-blog <?php echo $this->pageclass_sfx;?>">
	...
	<?php /** Begin Description **/ if ($this->params->def('show_description_image', 1)) : ?>
		<div class="category-img" style="width:38%;  float:left;">
			<div>
				<div class="shadow">
	...
	<?php endif; ?>
	<?php /** Begin Description **/ if ($this->params->get('show_description', 1)) : ?>
	<div class="category-desc" style="width:62%;">
		<div class="shadow">
