...
JHtml::addIncludePath(JPATH_BASE.DS.'templates'.DS.'kd_theenglishroom'.DS.'html'.DS.'com_content'.DS.'helpers');
...
<div class="rt-article"><div class="rt-article-bg">
	<div class="item-page<?php echo $this->pageclass_sfx?>">
		...
		<?php  if (isset($images->image_fulltext) and !empty($images->image_fulltext)) : ?>
			...
			<div class="img-fulltext-<?php echo htmlspecialchars($imgfloat); ?>" style="width:38%;">
			<div>
			<div class="shadow">
                        <img
